...
Version 5.2.0 is currently ranked around 3460 Elo (Blitz) and 3340 Elo (40/15) in the Computer Chess Rating Lists (CCRL):
...
In Fischer Random Chess, the single-threaded rating is around 3610 Elo:
