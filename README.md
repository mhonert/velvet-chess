...
Version 5.1.0 is currently ranked around 3420 Elo (Blitz) and 3310 Elo (40/15) in the Computer Chess Rating Lists (CCRL):
...
In Fischer Random Chess, the single-threaded rating is around 3540 Elo:
