...
def split_pgns():
    ...
    for file in pgnFiles:
        ...
        while True:
            ...
            #     continue
            #
            # if int(white_elo) < 2500:
            #     continue
            #
            # if int(black_elo) < 2500:
            #     continue
    ...
    for i in range(1, 239):
        ...
        while True:
            ...
            for move in game.mainline_moves():
                ...
                if candidate_fen is None and (is_capture or is_promotion or gives_check):
                    continue

                if candidate_fen is not None and (is_capture or gives_check):
                    candidate_fen = None
                    continue
                ...
                if is_white_turn and white_count <= black_count:
